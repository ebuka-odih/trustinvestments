...
<div id="content" class="site-content">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="text-center img-wrapper col-lg-10 mt-2">
                    <p>Trade over 40 major and minor Forex pairs on either the MT4 or MT5 platform.</p>
                </div>
            </div>
        </div>
    </section>
    <section id="pages_header" style=" background: url(wp-content/uploads/sites/11/2019/10/forex-trading-header.jpg) no-repeat center center transparent; " class="text-center header_spacing  header_img_bgr ">
    </section>
    ...
    <section class="usp-block-content clearfix white-bgr bordered ">
        <div class="container">
            <h2>Why Trade Forex with Trust InvestmentHub</h2>
            <div class="usp-wrapper slick-initialized slick-slider slick-dotted"><button class="slick-prev slick-arrow" aria-label="Previous" type="button" style="">Previous</button>
                <div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 4290px; transform: translate3d(-2340px, 0px, 0px);"><div class="usp-slide slick-slide slick-cloned" data-slick-index="-3" id="" aria-hidden="true" tabindex="-1" style="width: 350px;">
                            ...
                            <div class="usp eq-blocks">
                                ...
                                <img width="150" height="150" src="https://www.eightcap.com/en/wp-content/uploads/sites/11/2019/10/Spread.png" class="pt-3 wp-post-image entered lazyloaded" alt="" loading="lazy" data-lazy-src="https://www.eightcap.com/en/wp-content/uploads/sites/11/2019/10/Spread.png" data-ll-status="loaded"><noscript><img width="150" height="150" src="wp-content/uploads/sites/11/2019/10/Spread.png" class="pt-3 wp-post-image" alt="" loading="lazy" /></noscript>												<h3>Spreads from 0.0 pips</h3>
                            ...
                            <div class="usp eq-blocks">
                                ...
                                <img width="150" height="150" src="https://www.eightcap.com/en/wp-content/uploads/sites/11/2019/07/Dedicated_Customer_Support.png" class="pt-3 wp-post-image entered lazyloaded" alt="" loading="lazy" data-lazy-src="https://www.eightcap.com/en/wp-content/uploads/sites/11/2019/07/Dedicated_Customer_Support.png" data-ll-status="loaded"><noscript><img width="150" height="150" src="wp-content/uploads/sites/11/2019/07/Dedicated_Customer_Support.png" class="pt-3 wp-post-image" alt="" loading="lazy" /></noscript>												<h3>Personal Customer Support</h3>
                                <div class="usp-content">Find your feet with our two personalised account offerings. Our multilingual team is available to help you navigate the financial markets. You can trade at your own pace knowing we are only a phone call away.</div>
                            </div>
                            ...
                            <div class="usp eq-blocks">
                                ...
                                <img width="150" height="150" src="https://www.eightcap.com/en/wp-content/uploads/sites/11/2019/06/Trusted_Regulated_Broker.png" class="pt-3 wp-post-image entered lazyloaded" alt="" loading="lazy" data-lazy-src="https://www.eightcap.com/en/wp-content/uploads/sites/11/2019/06/Trusted_Regulated_Broker.png" data-ll-status="loaded"><noscript><img width="150" height="150" src="wp-content/uploads/sites/11/2019/06/Trusted_Regulated_Broker.png" class="pt-3 wp-post-image" alt="" loading="lazy" /></noscript>												<h3>Multi jurisdiction regulation</h3>
                                <div class="usp-content">Established in Australia and now regulated in multiple jurisdictions.</div>
                            </div>
                            ...
                            <div class="usp eq-blocks">
                                ...
                                <img width="150" height="150" src="https://www.eightcap.com/en/wp-content/uploads/sites/11/2019/08/Cutting_Edge_Technology.png" class="pt-3 wp-post-image entered lazyloaded" alt="" loading="lazy" data-lazy-src="https://www.eightcap.com/en/wp-content/uploads/sites/11/2019/08/Cutting_Edge_Technology.png" data-ll-status="loaded"><noscript><img width="150" height="150" src="wp-content/uploads/sites/11/2019/08/Cutting_Edge_Technology.png" class="pt-3 wp-post-image" alt="" loading="lazy" /></noscript>												<h3>MT4 &amp; MT5 Platforms</h3>
                                <div class="usp-content">Trade effortlessly on intuitive, market-leading platforms designed and built for traders worldwide via our cutting-edge technology infrastructure.</div>
                            </div>
                        </div><div class="usp-slide slick-slide slick-cloned slick-active" data-slick-index="4" id="" aria-hidden="false" tabindex="-1" style="width: 350px;">
                            <div class="usp eq-blocks">

                                <img width="150" height="150" class="pt-3 wp-post-image entered exited" alt="" loading="lazy" data-lazy-src="https://www.eightcap.com/en/wp-content/uploads/sites/11/2019/10/Spread.png" src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20150%20150'%3E%3C/svg%3E"><noscript><img width="150" height="150" src="wp-content/uploads/sites/11/2019/10/Spread.png" class="pt-3 wp-post-image" alt="" loading="lazy" /></noscript>												<h3>Spreads from 0.0 pips</h3>
                                <div class="usp-content">Trade FX on a Raw Account to take advantage of institutional-grade pricing. The price you need when you need it.</div>
                            </div>
                        </div><div class="usp-slide slick-slide slick-cloned slick-active" data-slick-index="5" id="" aria-hidden="false" tabindex="-1" style="width: 350px;">
                            <div class="usp eq-blocks">
                            ...
                            <div class="usp eq-blocks">
                                ...
                                <img width="150" height="150" class="pt-3 wp-post-image entered exited" alt="" loading="lazy" data-lazy-src="https://www.eightcap.com/en/wp-content/uploads/sites/11/2019/06/Trusted_Regulated_Broker.png" src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20150%20150'%3E%3C/svg%3E"><noscript><img width="150" height="150" src="wp-content/uploads/sites/11/2019/06/Trusted_Regulated_Broker.png" class="pt-3 wp-post-image" alt="" loading="lazy" /></noscript>												<h3>Multi jurisdiction regulation</h3>
                                <div class="usp-content">Established in Australia and now regulated in multiple jurisdictions.</div>
                            </div>
