...
@section('content')
    ...
    <div id="content" class="site-content">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 center-block">
                        <h1 class="page-title">MetaTrader 5 Trading Platform</h1>
                    </div>
                    <div class="text-center img-wrapper col-lg-10 mt-2">
                        <p>Enjoy multi-asset trading on a smart, intuitive platform. Choose MT5 if you're looking to trade Forex, Indices, Commodities or Shares. Advanced trading features, accessible via a desktop or mobile App and also via a Web Trader version.</p>
                    </div>
                </div>
            </div>
        </section>
        <section id="pages_header" style=" background: url(wp-content/uploads/sites/11/2019/10/mt5-header-1.jpg) no-repeat center center transparent; " class="text-center header_spacing  header_img_bgr ">
        </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="mt-3 mb-4 col-lg-10 img-wrapper text-center">
                        ...
                        <a href="https://coinmarketcap.com" class="btn blue-bordered-btn rounded-btn mobile-button-space">Open WebTrader</a>
                    </div>
                </div>
            </div>
        </div>
        <section class="usp-block-content clearfix grey-bgr bordered ">
            <div class="container">
                <h2>Key features of MT5</h2>
                <div class="text-center img-wrapper col-lg-10 mt-4 mb-4">
                    <p>As an intuitive and fully customisable trading interface, MT5 provides a smooth and efficient trading experience for multi-asset traders via the Web Trader or desktop and mobile Apps.</p>
                </div>
                <div class="usp-wrapper slick-initialized slick-slider slick-dotted"><button class="slick-prev slick-arrow" aria-label="Previous" type="button" style="">Previous</button>
                    <div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 5070px; transform: translate3d(-1170px, 0px, 0px);"><div class="usp-slide slick-slide slick-cloned" data-slick-index="-3" id="" aria-hidden="true" tabindex="-1" style="width: 350px;">
                                <div class="usp eq-blocks">

                                    <h3>Advanced Charting Package</h3>
                                    <div class="usp-content">Analyse short and long term price trends with the powerful charting capabilities of MT5. Charts in 21 time-frames plus 80 built-in indicators and analytical objects, all at your fingertips.</div>
                                </div>
                                ...
                                <div class="usp eq-blocks">
                                    ...
                                    <div class="usp-content">Get a deeper look at what is driving market movement with the Financial News and Economic Calendar features. Respond fast to news-driven movement.</div>
                                </div>
                            </div><div class="usp-slide slick-slide slick-cloned" data-slick-index="-1" id="" aria-hidden="true" tabindex="-1" style="width: 350px;">
                                <div class="usp eq-blocks">

                                    <h3>Web Trader Platform</h3>
                                    <div class="usp-content">One of the key differences between MT4 and MT5 is the web browser version of the MT5 platform. No desktop download required and accessible from any Windows, MacOS and Linux powered devices.</div>
                                </div>
                                ...
                                <div class="usp eq-blocks">
                                    ...
                                    <div class="usp-content">Purchase a trading robot or build your own to automate your analysis and trading execution. Use the MQL5 Wizard to create your own robot from easy-to-use ready-made blocks, or develop one in the MQL5 IDE development environment if you have more experience.</div>
                                </div>
                                ...
                                <div class="usp eq-blocks">
                                    ...
                                    <h3>Powerful Trading System</h3>
                                    <div class="usp-content">Trade with complete control using the Market Depth feature, netting or hedging modes or 1 click trading direct from charts.</div>
                                </div>
                            ...
                            </div><div class="usp-slide slick-slide" data-slick-index="4" aria-hidden="true" tabindex="-1" role="tabpanel" id="slick-slide04" aria-describedby="slick-slide-control04" style="width: 350px;">
                                <div class="usp eq-blocks">
        ...
        <section class="content-block  ">
            <div class="container">
                <h2 class="text-center">Why trade on MT5 with Trust InvestmentHub?</h2>
                <div class="img-wrapper text-center">
                    <div class="col content ">
                        <p>Experience MT5 delivered on our technology infrastructure - engineered with speed, transparent pricing and reliability in mind.</p>
                    </div>
                </div>
                <div class="usp-block-content">
                    <div class="usp-wrapper slick-initialized slick-slider slick-dotted"><button class="slick-prev slick-arrow" aria-label="Previous" type="button" style="">Previous</button>
                        <div class="slick-list draggable"><div class="slick-track" style="opacity: 1; width: 4290px; transform: translate3d(-1560px, 0px, 0px);"><div class="usp-slide slick-slide slick-cloned" data-slick-index="-3" id="" aria-hidden="true" tabindex="-1" style="width: 350px;">
                                ...
                                </div><div class="usp-slide slick-slide" data-slick-index="0" aria-hidden="true" tabindex="-1" role="tabpanel" id="slick-slide10" aria-describedby="slick-slide-control10" style="width: 350px;">
                                    <div class="usp equal-blocks">
                                ...
                                </div><div class="usp-slide slick-slide slick-current slick-active" data-slick-index="1" aria-hidden="false" tabindex="0" role="tabpanel" id="slick-slide11" aria-describedby="slick-slide-control11" style="width: 350px;">
                                    <div class="usp equal-blocks">
                                        <img width="150" height="150" src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20150%20150'%3E%3C/svg%3E" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" loading="lazy" data-lazy-src="https://www.eightcap.com/en/wp-content/uploads/sites/11/2019/06/Trusted_Regulated_Broker.png"><noscript><img width="150" height="150" src="wp-content/uploads/sites/11/2019/06/Trusted_Regulated_Broker.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" loading="lazy" /></noscript>												<h3>Multi jurisdiction regulation</h3>
                                        <div class="usp-content">Established in Australia and now regulated in multiple jurisdictions.</div>
                                    </div>
                                ...
                                </div><div class="usp-slide slick-slide slick-active" data-slick-index="3" aria-hidden="false" tabindex="0" role="tabpanel" id="slick-slide13" aria-describedby="slick-slide-control13" style="width: 350px;">
                                    <div class="usp equal-blocks">
                                        <img width="150" height="150" src="data:image/svg+xml,%3Csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%20150%20150'%3E%3C/svg%3E" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" loading="lazy" data-lazy-src="https://www.eightcap.com/en/wp-content/uploads/sites/11/2019/07/Premium-Liquidity.png"><noscript><img width="150" height="150" src="wp-content/uploads/sites/11/2019/07/Premium-Liquidity.png" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" loading="lazy" /></noscript>												<h3>Premium Liquidity</h3>
                                        <div class="usp-content">Our pricing is aggregated from multiple top-tier liquidity providers, allowing you to trade on spreads from as low as 0.0 pips.</div>
                                    </div>
